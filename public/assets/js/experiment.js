let nav = document.querySelector('.navMenu');
        ...
        let liensColor1 =  document.querySelector('.liensColor1');
        let liensColor2 =  document.querySelector('.liensColor2');
        let liensColor3 =  document.querySelector('.liensColor3');
        let liensColor4 =  document.querySelector('.liensColor4');
        let liensColor5 =  document.querySelector('.liensColor5');
